...
public class FormComponentsTypeImpl implements captor.domainsystem.FormComponentsType, com.sun.xml.bind.JAXBObject, captor.domainsystem.impl.runtime.UnmarshallableObject, captor.domainsystem.impl.runtime.XMLSerializable, captor.domainsystem.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _FormComponent;
    public final static java.lang.Class version = (captor.domainsystem.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (captor.domainsystem.FormComponentsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getFormComponent() {
        if (_FormComponent == null) {
            _FormComponent = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _FormComponent;
    }

    public java.util.List getFormComponent() {
        return _getFormComponent();
    }
    ...
    public captor.domainsystem.impl.runtime.UnmarshallingEventHandler createUnmarshaller(captor.domainsystem.impl.runtime.UnmarshallingContext context) {
        return new captor.domainsystem.impl.FormComponentsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_FormComponent == null)? 0 :_FormComponent.size());
        while (idx1 != len1) {
            context.startElement("", "formComponent");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _FormComponent.get(idx_0 ++)), "FormComponent");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _FormComponent.get(idx_1 ++)), "FormComponent");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _FormComponent.get(idx1 ++)), "FormComponent");
            context.endElement();
        }
    }
...
+"\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000%captor.doma"
+"insystem.FormComponentTypet\u0000+http://java.sun.com/jaxb/xjc/du"
...
+"://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\rformCompo"
+"nentt\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\be"
...
+"essionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\fq\u0000~\u0000\u0005q\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0010x"));
        ...
        extends captor.domainsystem.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return captor.domainsystem.impl.FormComponentsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("fullname" == ___local)&&("" == ___uri)) {
                            _getFormComponent().add(((captor.domainsystem.impl.FormComponentTypeImpl) spawnChildFromEnterElement((captor.domainsystem.impl.FormComponentTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
