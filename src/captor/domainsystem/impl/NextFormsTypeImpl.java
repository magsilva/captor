...
public class NextFormsTypeImpl implements captor.domainsystem.NextFormsType, com.sun.xml.bind.JAXBObject, captor.domainsystem.impl.runtime.UnmarshallableObject, captor.domainsystem.impl.runtime.XMLSerializable, captor.domainsystem.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _NextForm;
    public final static java.lang.Class version = (captor.domainsystem.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (captor.domainsystem.NextFormsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getNextForm() {
        if (_NextForm == null) {
            _NextForm = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _NextForm;
    }

    public java.util.List getNextForm() {
        return _getNextForm();
    }
    ...
    public captor.domainsystem.impl.runtime.UnmarshallingEventHandler createUnmarshaller(captor.domainsystem.impl.runtime.UnmarshallingContext context) {
        return new captor.domainsystem.impl.NextFormsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_NextForm == null)? 0 :_NextForm.size());
        while (idx1 != len1) {
            context.startElement("", "nextForm");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _NextForm.get(idx_0 ++)), "NextForm");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _NextForm.get(idx_1 ++)), "NextForm");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _NextForm.get(idx1 ++)), "NextForm");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000 captor.domainsystem.NextFormTypet\u0000+http://java.sun.com/"
...
+"\u0000\bnextFormt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"x"));
        ...
        extends captor.domainsystem.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return captor.domainsystem.impl.NextFormsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _getNextForm().add(((captor.domainsystem.impl.NextFormTypeImpl) spawnChildFromEnterElement((captor.domainsystem.impl.NextFormTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
