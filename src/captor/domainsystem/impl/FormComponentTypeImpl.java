...
public class FormComponentTypeImpl implements captor.domainsystem.FormComponentType, com.sun.xml.bind.JAXBObject, captor.domainsystem.impl.runtime.UnmarshallableObject, captor.domainsystem.impl.runtime.XMLSerializable, captor.domainsystem.impl.runtime.ValidatableObject
{

    protected captor.domainsystem.ParametersType _Parameters;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (captor.domainsystem.FormComponentType.class);
    }

    public captor.domainsystem.ParametersType getParameters() {
        return _Parameters;
    }

    public void setParameters(captor.domainsystem.ParametersType value) {
        _Parameters = value;
    }
    ...
    public captor.domainsystem.impl.runtime.UnmarshallingEventHandler createUnmarshaller(captor.domainsystem.impl.runtime.UnmarshallingContext context) {
        return new captor.domainsystem.impl.FormComponentTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u0000\b\u0001pq\u0000~\u0000Eq\u0000~\u0000Cq\u0000~\u0000\u0005q\u0000~\u0000Gq\u0000~\u0000-q\u0000~\u0000Sq\u0000~\u0000\nq\u0000~\u0000Jx"));
        ...
        extends captor.domainsystem.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return captor.domainsystem.impl.FormComponentTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("parameter" == ___local)&&("" == ___uri)) {
                            _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromEnterElement((captor.domainsystem.impl.ParametersTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromEnterElement((captor.domainsystem.impl.ParametersTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  4 :
                        _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromLeaveElement((captor.domainsystem.impl.ParametersTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        continue outer;
                    case  4 :
                        _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromEnterAttribute((captor.domainsystem.impl.ParametersTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        continue outer;
                    case  4 :
                        _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromLeaveAttribute((captor.domainsystem.impl.ParametersTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            continue outer;
                        case  4 :
                            _Parameters = ((captor.domainsystem.impl.ParametersTypeImpl) spawnChildFromText((captor.domainsystem.impl.ParametersTypeImpl.class), 5, value));
                            return ;
                        case  1 :
                            eatText1(value);
                            state = 2;
