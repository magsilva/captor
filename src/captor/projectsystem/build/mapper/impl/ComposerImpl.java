...
public class ComposerImpl
    extends captor.projectsystem.build.mapper.impl.ComposerTypeImpl
    implements captor.projectsystem.build.mapper.Composer, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, captor.projectsystem.build.mapper.impl.runtime.UnmarshallableObject, captor.projectsystem.build.mapper.impl.runtime.XMLSerializable, captor.projectsystem.build.mapper.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (captor.projectsystem.build.mapper.Composer.class);
    }
    ...
    public captor.projectsystem.build.mapper.impl.runtime.UnmarshallingEventHandler createUnmarshaller(captor.projectsystem.build.mapper.impl.runtime.UnmarshallingContext context) {
        return new captor.projectsystem.build.mapper.impl.ComposerImpl.Unmarshaller(context);
    }

    public void serializeBody(captor.projectsystem.build.mapper.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "composer");
...
+"q\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000*captor.projectsystem.build.mapper.MainTypet\u0000+h"
...
+"nstanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0004maint\u0000\u0000sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000f"
+"ppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000+captor.pro"
+"jectsystem.build.mapper.TasksTypeq\u0000~\u0000$sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000"
+"~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0005tasksq\u0000~\u0000?sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015psq\u0000~\u0000\'pp"
+"sr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlway"
+"sValidxq\u0000~\u0000,q\u0000~\u00001t\u0000\u0006stringsr\u00005com.sun.msv.datatype.xsd.White"
+"SpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00004\u0001q\u0000~\u00007sq\u0000~\u00008q\u0000~\u0000Qq\u0000~"
+"\u00001sq\u0000~\u0000 t\u0000\u0004nameq\u0000~\u0000?q\u0000~\u0000\u001fsq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001f"
+"sq\u0000~\u0000 t\u0000\bcomposerq\u0000~\u0000?sr\u0000\"com.sun.msv.grammar.ExpressionPool"
...
+"sv/grammar/ExpressionPool;xp\u0000\u0000\u0000\r\u0001pq\u0000~\u0000Lq\u0000~\u0000\nq\u0000~\u0000\rq\u0000~\u0000Aq\u0000~\u0000\u0010q"
+"\u0000~\u0000Cq\u0000~\u0000%q\u0000~\u0000Hq\u0000~\u0000Wq\u0000~\u0000\tq\u0000~\u0000\u0013q\u0000~\u0000Dq\u0000~\u0000\u000bx"));
        }
        ...
        extends captor.projectsystem.build.mapper.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return captor.projectsystem.build.mapper.impl.ComposerImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        ...
                        if (("main" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((captor.projectsystem.build.mapper.impl.ComposerTypeImpl)captor.projectsystem.build.mapper.impl.ComposerImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("composer" == ___local)&&("" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((captor.projectsystem.build.mapper.impl.ComposerTypeImpl)captor.projectsystem.build.mapper.impl.ComposerImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
