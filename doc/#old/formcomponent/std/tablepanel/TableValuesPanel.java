package captor.windowsystem.formcomponent.std.tablepanel;
...
public class TableValuesPanel extends CaptorFrame  implements ActionListener, KeyListener  {
    ...
    private JScrollPane body()  {
        ...
        Dimension d3 = new Dimension(300,325);
    ...
    private boolean ok()  {
		...
		for ( int i = 0; i < tableModel.getColumnCount(); i++ )  {
	        ...
	        if ( tf.getText().trim().equals("") )  {
		        String value = (String) tablePanel.getParameter().get("COLNAME1");
		        JOptionPane.showMessageDialog(this, "The column " + value + " has a empty value.");
	            return false;
	        }
