package captor.windowsystem.formcomponent.std.textpanel;
 ...
 *
 */
public class TextPanel extends FormComponent implements KeyListener {
    ...
    public TextPanel(Model model, DefaultMutableTreeNode node) {
        super(model, node);
        id = "";
        create();
    }
